...
HighTom::HighTom(const Vector& position)  : GameObject(position)
{
	//generate vertices
...
void HighTom::update(double elapsedTime)
{
...
bool HighTom::collision(const Vector& otherObject)
{
	return m_Position.distance(otherObject) < .005;
}

void HighTom::destroy()
{
