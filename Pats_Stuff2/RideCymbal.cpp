...
RideCymbal::RideCymbal(const Vector& position)  : GameObject(position)
{
	//generate vertices
...
void RideCymbal::update(double elapsedTime)
{
	
}

void RideCymbal::render()
{
	glPushMatrix();
...
bool RideCymbal::collision(const Vector& otherObject)
{
	return m_Position.distance(otherObject) < .005;
}

void RideCymbal::destroy()
{
